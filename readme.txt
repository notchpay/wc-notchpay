...
Notch Pay provides merchants with the tools and services to accept online payments from local and international customers using Mobile Money, Mastercard, Visa and bank accounts.
== Description ==
...
This plugin is meant to be used by merchants in Cameroon.

= Plugin Features =

*   __Accept payment__ via Mastercard, Visa, Mobile Money (Cameroon).

= Suggestions / Feature Request =

If you have suggestions or a new feature request, feel free to get in touch with me via the contact form on my website [here](http://bosun.me/get-in-touch/)

You can also follow us on Twitter! **[@thenotchpay](https://twitter.com/thenotchpay)**
...
== Changelog ==
= 2.0 -  November 20, 2022 =
*   Fixed some bugs
*   Migrated to Notch Pay v2.0
= 1.1.1 -  November 05, 2022 =
*   Added plugin assets
